...
export default function ProfileSafety() {
  ...
  const saveContacts = async () => {
    ...
    try {
      ...
      setSaveMsg("❌ Failed to save contacts");
    }
    setSaving(false);
    setTimeout(() => setSaveMsg(""), 3000);
  };
    ...
    <>
      ...
      <div className="ps-container">
        ...
        <div className="ps-header">
          ...
          {/* Home button — top right of header */}
        ...
        {activeSection === "profile" && (
          <div className="ps-section">
            ...
            <div className="ps-grid">
              ...
              <div className="ps-field">
                <label>Email</label>
                <input value={profile.email} disabled className="ps-disabled" />
              </div>
            </div>
        ...
        {activeSection === "security" && (
          <div className="ps-section">
            ...
            <div className="ps-logout-wrap">
              <button className="ps-logout-btn" onClick={() => { localStorage.removeItem("token"); navigate("/auth"); }}>
                🚪 Logout
              </button>
            </div>
          </div>
        ...
        {activeSection === "contacts" && (
          <div className="ps-section">
            ...
            <p className="ps-section-sub">Add up to 3 trusted people. They'll receive your location via WhatsApp when you trigger SOS.</p>
            {contacts.map((c, i) => (
              <div key={i} className="ps-contact-card">
                ...
                <div className="ps-grid">
                  ...
                  <div className="ps-field">
                    ...
                    <input value={c.phone} onChange={e => updateContact(i, "phone", e.target.value)} placeholder="+91 98765 43210" />
                  </div>
                  <div className="ps-field">
        ...
        {activeSection === "sos" && (
          <div className="ps-section ps-sos-section">
            ...
            <p className="ps-section-sub">
              Tap the button below to instantly send your GPS location to all your emergency contacts via WhatsApp.
            </p>
            ...
            <div className="ps-sos-info">
              ...
              <div className="ps-sos-info-item"><span>💬</span><p>Opens WhatsApp for each contact</p></div>
              <div className="ps-sos-info-item"><span>🔗</span><p>Includes Google Maps link</p></div>
