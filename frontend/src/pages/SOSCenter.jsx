...
//   const [cdTotal,     setCdTotal]     = useState(10); // track total for ring %
...
//         {sosMsg && (
//           <div className={`sos-toast ${sosMsg.startsWith("✅") ? "sos-toast-ok" : "sos-toast-warn"}`}>{sosMsg}</div>
//         )}
...
//             {/* Shake SOS — primary mobile trigger */}
//             <ShakeSOSCard
//               armed={shakeArmed}
...
//             {/* Volume SOS — shown with mobile-unsupported notice */}
//             <VolumeSOSCard
//               armed={volumeArmed}
