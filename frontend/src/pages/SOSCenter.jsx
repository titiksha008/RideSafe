      ...
      async (pos) => {
        try {
          ...
          await axios.post(`${API}/sos/log`,
            { type: source, lat: pos.coords.latitude, lng: pos.coords.longitude, contactsAlerted: alerted.map(c => c.name || c.phone) },
            { headers: authHeaders() }
          ).catch(() => {});
          ...
          // Show confirmation overlay (for volume / non-manual triggers)
          if (source !== "manual") {
            setSosConfirm(
  ...
  return (
    <>
      ...
      <div className="sos-page">
        ...
        {/* Confirmation overlay for volume-triggered SOS */}
        <SOSConfirmation
          trigger={sosConfirm}
        ...
        {activeTab === "features" && (
          <div className="sos-tab-panel">
            ...
            {/* More features will slot in here */}
          </div>
        )}
