...
// // ── MERGED: friend's FakeCall button + callAi danger-keyword detection
// //            + your Volume SOS, SOSEvent log POST, Wake Lock, Features tab ──
...
// // ── Status badge ───────────────────────────────────────────────
// function StatusBadge({ active, volumeArmed }) {
//   if (active) return (
...
// // ── SOS triggered confirmation overlay ────────────────────────
...
//           Triggered via <strong>{trigger}</strong>.<br />
...
//     shake:     { bg: "#2d2d0a", border: "#713f12", text: "#fde68a", label: "Shake"     },
...
//   const [sosConfirm, setSosConfirm]     = useState(null); // trigger source string or null
...
//   // ── Core SOS sender ──────────────────────────────────────────
//   // source: "manual" | "volume" | "shake" | "crash" etc.
//   const handleSOS = useCallback((source = "manual") => {
//     if (contacts.length === 0 && source === "manual") {
...
//       async (pos) => {
//         try {
//           // Send SOS via profile route (existing backend)
...
//           // Log the event with its source type
//           await axios.post(
//             `${API}/sos/log`,
//             {
//               type:            source,
...
//           // Refresh log
//           const logRes = await axios.get(`${API}/sos/log`, { headers: authHeaders() })
//             .catch(() => ({ data: [] }));
//           setSosLog(logRes.data || []);

//           // Show confirmation overlay for non-manual triggers
//           if (source !== "manual") {
//             setSosConfirm(
//               source === "volume" ? "Volume Button × 3" : source
//             );
//           }
//         } catch (e) {
...
//       setSosLog([]);
//     } catch {
//       alert("Could not clear SOS history.");
//     }
//   };
...
//         {/* Confirmation overlay for volume / non-manual triggers */}
//         <SOSConfirmation
//           trigger={sosConfirm}
...
//             <StatusBadge active={sosActive} volumeArmed={volumeArmed} />
...
//             </p>
//             {/* Fake Call button — from friend's code */}
//             <button
...
//                 <>
//                   ⚡ Features
//                   {volumeArmed && <span className="sos-tab-armed-dot" />}
//                 </>
//               )}
//               {tab === "log" && "📋 History"}
//             </button>
...
//             <div className="sos-section-header">
//               <div>
//                 <h2 className="sos-section-title">SOS Features</h2>
//                 <p className="sos-section-desc">
//                   Arm these to trigger SOS without touching the screen.
//                 </p>
//               </div>
//             </div>
...
//               </div>
//               {sosLog.length > 0 && (
//                 <button className="sos-btn-ghost sos-btn-danger" onClick={handleClearLog}>
//                   Clear All
//                 </button>
//               )}
//             </div>
