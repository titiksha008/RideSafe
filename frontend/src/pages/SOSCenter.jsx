...
//   const [error, setError]             = useState("");
//   const [activeTab, setActiveTab]     = useState("contacts"); // contacts | log | settings
...
//             <div className="sos-section-header">
//               <div>
//                 <h2 className="sos-section-title">SOS Settings</h2>
//                 <p className="sos-section-desc">Configure how your SOS features behave.</p>
//               </div>
//             </div>

//             <div className="sos-settings-list">

//               {/* Placeholder setting rows — wire up later when features are added */}
//               <div className="sos-setting-row sos-setting-disabled">
//                 <div className="sos-setting-info">
//                   <p className="sos-setting-title">🤳 Fake Call</p>
//                   <p className="sos-setting-desc">Simulate an incoming call to exit uncomfortable situations.</p>
//                 </div>
//                 <span className="sos-coming-soon">Coming soon</span>
//               </div>

//               <div className="sos-setting-row sos-setting-disabled">
//                 <div className="sos-setting-info">
//                   <p className="sos-setting-title">📳 Shake-to-SOS</p>
//                   <p className="sos-setting-desc">Trigger SOS by shaking your phone.</p>
//                 </div>
//                 <span className="sos-coming-soon">Coming soon</span>
//               </div>
...
//               <div className="sos-setting-row sos-setting-disabled">
//                 <div className="sos-setting-info">
//                   <p className="sos-setting-title">🔊 Volume Button SOS</p>
//                   <p className="sos-setting-desc">Hold both volume buttons for 3s to trigger SOS.</p>
//                 </div>
//                 <span className="sos-coming-soon">Coming soon</span>
//               </div>
...
//               <div className="sos-setting-row sos-setting-disabled">
//                 <div className="sos-setting-info">
//                   <p className="sos-setting-title">🌙 Night Mode Auto-Arm</p>
//                   <p className="sos-setting-desc">Automatically arm SOS features during night rides.</p>
//                 </div>
//                 <span className="sos-coming-soon">Coming soon</span>
//               </div>
...
//               <div className="sos-setting-row sos-setting-disabled">
//                 <div className="sos-setting-info">
//                   <p className="sos-setting-title">💥 Crash Detection</p>
//                   <p className="sos-setting-desc">Auto-alert contacts if a sudden impact is detected.</p>
//                 </div>
//                 <span className="sos-coming-soon">Coming soon</span>
//               </div>
...
//               <div className="sos-setting-row sos-setting-disabled">
//                 <div className="sos-setting-info">
//                   <p className="sos-setting-title">🎙 Scream Detection</p>
//                   <p className="sos-setting-desc">Trigger SOS if a scream is detected by the mic.</p>
//                 </div>
//                 <span className="sos-coming-soon">Coming soon</span>
//               </div>
